...
public class InputComponent extends EntityComponent {
    ...
    public InputAction keyAbility1 = InputAction.Key("Ability 1", Input.Keys.NUM_1);
    public InputAction keyAbility2 = InputAction.Key("Ability 2", Input.Keys.NUM_2);
    public InputAction keyAbility3 = InputAction.Key("Ability 3", Input.Keys.NUM_3);
    public InputAction keyAbility4 = InputAction.Key("Ability 4", Input.Keys.NUM_4);
